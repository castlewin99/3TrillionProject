          ...
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6">
                ...
                <h1 class="h2 text-uppercase mb-3">최대 40% 할인</h1>
                <h1 class="h2 text-uppercase mb-3">역대급 K-Black Friday</h1><a class="btn btn-dark" href="shop.html">Browse collections</a>
              </div>
            </div>
          </div>
        </section>
